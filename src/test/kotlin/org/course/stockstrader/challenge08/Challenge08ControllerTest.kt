package org.course.stockstrader.challenge08
...
class Challenge08ControllerTest @Autowired constructor(val stocksRepository: StocksRepository,
    ...
    /**
     * Exercise C:
     * For instructions go to @see StockTraderController#channelTriggeredStocksFlow
     */
    @Test
